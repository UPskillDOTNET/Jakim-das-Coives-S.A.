        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DebitoDireto_Nome = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Rua = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CodigoPostal = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Freguesia = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DataSubscricao = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Credencial_MetodosPagamento_MetodoId",
                        column: x => x.MetodoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Nome = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Carteira = table.Column<double>(type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Credencial_CredencialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefreshToken_AspNetUsers_UtilizadorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NifPagador = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NifUtilizador = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ...
                    ReservaParqueId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CredencialId",
                table: "AspNetUsers",
                column: "CredencialId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Credencial_MetodoId",
                table: "Credencial",
                column: "MetodoId");

            migrationBuilder.CreateIndex(
                name: "IX_RefreshToken_UtilizadorId",
                table: "RefreshToken",
                column: "UtilizadorId");
