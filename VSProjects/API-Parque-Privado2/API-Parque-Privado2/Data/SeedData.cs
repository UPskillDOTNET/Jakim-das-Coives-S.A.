    ...
    public class SeedData
    {
        public static void Initialize(API_Parque_Privado2Context context)
        {
            ...
            context.Parques.AddRange(
                ...
                new Parque { Rua = "Lugar do Porto", FreguesiaId = 2 }
            );
            context.SaveChanges();

            context.Lugares.AddRange(
                new Lugar { Numero = 1, Fila = "AA", Andar = 1, ParqueId = 1, Preco = 5 },
                new Lugar { Numero = 2, Fila = "BB", Andar = 2, ParqueId = 2, Preco = 6 },
                new Lugar { Numero = 3, Fila = "CC", Andar = 3, ParqueId = 2, Preco = 7 },
                new Lugar { Numero = 4, Fila = "DD", Andar = 4, ParqueId = 2, Preco = 8 },
                new Lugar { Numero = 5, Fila = "EE", Andar = 5, ParqueId = 2, Preco = 9 }
            );
            context.SaveChanges();
            ...
            context.Reservas.AddRange(
                ...
                new Reserva { NifCliente = 554466887, LugarId = 3, Inicio = DateTime.Parse("2021-01-30 10:00:00"), Fim = DateTime.Parse("2021-01-30 13:00:00") },
